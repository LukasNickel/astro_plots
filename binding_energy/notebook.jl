...
# ╔═╡ 169b803a-0034-11ec-28e4-6f1e5efacb09
begin
	using CSV
	using Plots
	using DataFrames
...
# ╔═╡ 718d6bd2-34f4-4584-82ac-080b4b11bb11
...
# ╔═╡ fbc5ee9c-5498-4e7a-863b-9d185051e4ce
function max_binding_energy(df, col)
	gdf = groupby(df, col)
	combine(gdf, :binding_energy_per_nucleon => maximum)
end

# ╔═╡ 4b370850-1ab8-45be-b5d8-4345172b62b8
df = read_df("data")

# ╔═╡ b888ccfc-712c-4d9f-8072-bdef622f0e9e
max_bindings = max_binding_energy(df, "A")

# ╔═╡ 84adabaf-16ee-405b-abcc-ba6e3b49e08b
begin
	A = max_bindings.A
...
# ╔═╡ fe9ffce9-3a32-4eb7-ab8d-83ae4758bfe9
savefig(p, "binding_energy.png")

# ╔═╡ 82a08d4d-3f4a-498c-83f9-5b6e60ce8252
savefig(p, "binding_energy.svg")

# ╔═╡ bfa37498-862f-4f8b-8e47-74799e6b0b41
x = max_bindings.binding_energy_per_nucleon_maximum[[1,4,8,12,16,56]]

# ╔═╡ 4d5e5e17-8558-4543-acce-6b2ade15bad2
x .> 7500

# ╔═╡ 361f949f-42d3-4413-9d1e-1c6c51f23f83
append!(x[x .> 7500] .+ 300, x[x .> 7500] .+ 300)
