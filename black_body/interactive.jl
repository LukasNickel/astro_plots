...
# ╔═╡ 8fff3cc7-03dc-4e19-8f25-c84f391e4583
begin
	using Unitful
	using PlutoUI
	...
	using Plots
	using Printf
	#plotly() # I feel like its too bloated
	gr()
	#pgfplotsx() # this is way to slow for interactive use
end

# ╔═╡ c0469eb9-af47-45ef-b11e-7e91e797b407
begin
...
# ╔═╡ 23c34e85-c803-4a56-ab6f-51fe684ffdd0
...
# ╔═╡ 9e524dd9-f608-4abc-ba30-bff98524477c
begin
	ls2 = range(0.0001, stop=10, length=100)
	plot(
		ls2,
		planck_spectrum(ls2.*1u"μm", 1000u"K"),
		#xscale=:log10,
		#yscale=:log10,
		#ylim=[0, ],
		xlim=[0.01, 10],
		xlabel="Wellenlänge [μm]",
		ylabel="Intensität [W/m³]",
		label="10000 K",
		color=:black,
		grid=true,
	)
	plot!(ls2, planck_spectrum(ls2.*1u"μm", 900u"K"), label="3000K", color=:black)
	plot!(ls2, planck_spectrum(ls2.*1u"μm", 800u"K"), label="1000K", color=:black)
	#add_visible_light(u"μm", 10^15, 0.5)

end

# ╔═╡ 5ca8e154-7b38-4045-a2d3-d7f36aa38651
